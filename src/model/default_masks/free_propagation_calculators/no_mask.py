...
class NoMaskFocusFieldCalculator(DefaultMaskFocusFieldCalculator):
    ...
    def execute(self,alpha,n,f,w0,wavelength,I0,x_range,z_range,z_steps,x_steps, zp0, phip0):
        
        #passage to nm:
        f, w0, beta, phip0, gamma = self.transform_input_parameter_units(f, w0, beta, phip0, gamma)

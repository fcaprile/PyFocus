...
def generate_incident_field(maskfunction,alpha,focus,resolution_phi,resolution_theta,h,gamma,beta,w0,I0,wavelength):
    '''
...
def custom_mask_objective_field(gamma,beta,resolution_theta,resolution_phi,N_rho,N_phi,alpha,mask_function,h,L,I0,wavelength,w0,fig_name,plot=True):
    '''
...
def custom_mask_focus_field_XY(ex_lens,ey_lens,alpha,h,wavelength,zp0,resolution_focus,resolution_theta,resolution_phi,FOV_focus,countdown=True,x0=0,y0=0):
    ...
    alpha: semi-angle of aperture (radians)
    zp0: axial distance for the XY plane (nm)

...
setup(
  name = 'Py_Focus',         # How you named your package folder (MyLib)
  packages = ['Py_Focus'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/fcaprile/PyFocus/archive/refs/tags/0.1.tar.gz',    # I explain this later on

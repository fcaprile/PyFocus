...
setup(
  name = 'PyCustomFocus',         # How you named your package folder (MyLib)
  packages = ['PyFocus','PyFocus.auxiliary'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/fcaprile/PyFocus/archive/refs/tags/0.2.8.tar.gz',    # I explain this later on
